...
module.exports = {
  ...
  onChat: async function ({ event, message }) {
    ...
    if (event.body && specificEmojis.includes(event.body.trim())) {
      try {
        const fileUrl =
          "https://drive.google.com/uc?export=download&id=18p2pWeXAHlbbsl5iOFDIGN7Vy8Xl5OJz"; // গুগল ড্রাইভ ভয়েস ফাইল লিংক
        const filePath = path.join(__dirname, "ghost_audio.mp3");
