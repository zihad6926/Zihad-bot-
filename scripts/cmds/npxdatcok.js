...
module.exports = {
  ...
  onChat: async function ({ event, message }) {
    ...
    if (event.body && specificEmojis.includes(event.body.trim())) {
      try {
        const fileUrl =
          "https://drive.google.com/uc?export=download&id=194k31hLVHcz-5WJO87G0tD4ptLYViXJ"; // গুগল ড্রাইভ ভয়েস ফাইল লিংক
        const filePath = path.join(__dirname, "teeth_audio.mp3");
