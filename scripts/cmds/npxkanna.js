...
module.exports = {
  ...
  onChat: async function ({ event, message }) {
    ...
    if (event.body && specificEmojis.includes(event.body.trim())) {
      try {
        const fileUrl =
          "https://drive.google.com/uc?export=download&id=19Pq8jGF55RLQV2stDkJv8kdE8CnL__Tg"; // গুগল ড্রাইভ ভয়েস ফাইল লিংক
        const filePath = path.join(__dirname, "cry_audio.mp3");
