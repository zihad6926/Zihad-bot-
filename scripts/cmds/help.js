...
const doNotDelete = "[ 𝗭𝗜𝗛𝗔𝗗 ]"; // changing this wont change the goatbot V2 of list cmd it is just a decoyy
...
╚═╝░░░░░╚═╝╚═╝╚═╝░░░░░╚═╝\n\n◦❭❯❱ 𝗖𝗢𝗠𝗠𝗔𝗡𝗗𝗦 & 𝗖𝗔𝗧𝗘𝗚𝗢𝗥𝗬 ❰❮❬◦`; // replace with your name 
			...
			msg += `♥️ | 𝗭𝗜𝗛𝗔𝗗 - 𝗕𝗢𝗧 𝗩𝟮`; // its not decoy so change it if you want 
